...
$router->get('/pagers/{id}/broken',        [$workflowController, 'showBroken'],          [$authMw, $adminMw]);
$router->post('/pagers/{id}/broken',       [$workflowController, 'markBroken'],          [$authMw, $adminMw]);
$router->get('/pagers/{id}/preparation',   [$workflowController, 'showPreparation'],     [$authMw, $adminMw]);
$router->post('/pagers/{id}/preparation',  [$workflowController, 'completePreparation'], [$authMw, $adminMw]);
...
$router->get('/repairs/{id}/complete',      [$workflowController,  'showRepaired'],[$authMw, $adminMw]);
$router->post('/repairs/{id}/complete',     [$workflowController,  'repaired'],    [$authMw, $adminMw]);
...
$router->post('/settings/transitions/update', [$settingsController, 'updateTransition'], [$authMw, $adminMw]);
$router->post('/settings/symptoms/save',      [$settingsController, 'saveSym'],          [$authMw, $adminMw]);
$router->post('/settings/symptoms/delete',    [$settingsController, 'deleteSym'],        [$authMw, $adminMw]);
$router->post('/settings/checks/save',        [$settingsController, 'saveCheck'],        [$authMw, $adminMw]);
$router->post('/settings/checks/delete',      [$settingsController, 'deleteCheck'],      [$authMw, $adminMw]);
