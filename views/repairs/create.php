...
<div class="card">
    <form method="POST" action="/pagers/<?= $pagerId ?>/repairs" enctype="multipart/form-data">
        <?= CSRF::field() ?>
        ...
        <div class="form-group">
            <label for="receipt"><i class="fas fa-paperclip"></i> Kvittering (PDF, JPG eller PNG, maks. 5 MB)</label>
