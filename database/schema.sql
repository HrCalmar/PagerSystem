...
--
-- Vært: localhost:3306
-- Genereringstid: 06. 03 2026 kl. 14:56:58
...
--
-- Struktur-dump for tabellen `defect_reports`
--
...
--
-- Struktur-dump for tabellen `defect_report_symptoms`
--

CREATE TABLE `defect_report_symptoms` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Struktur-dump for tabellen `defect_symptoms`
--
...
--
-- Struktur-dump for tabellen `preparation_checks`
--

CREATE TABLE `preparation_checks` (
  `id` int(10) UNSIGNED NOT NULL,
  `label` varchar(100) NOT NULL,
  `sort_order` int(11) NOT NULL DEFAULT 0,
  `is_enabled` tinyint(1) NOT NULL DEFAULT 1
...
--
-- Struktur-dump for tabellen `preparation_results`
--

CREATE TABLE `preparation_results` (
  `id` int(10) UNSIGNED NOT NULL,
  `pager_id` int(10) UNSIGNED NOT NULL,
  `checked_by_user_id` int(10) UNSIGNED DEFAULT NULL,
  `completed_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `all_ok` tinyint(1) NOT NULL DEFAULT 0,
  `forced` tinyint(1) NOT NULL DEFAULT 0,
  `forced_reason` text DEFAULT NULL,
...
--
-- Struktur-dump for tabellen `preparation_result_items`
--

CREATE TABLE `preparation_result_items` (
  `id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `staff` (
  ...
  `ric_code` varchar(20) DEFAULT NULL,
  `odin_id` varchar(20) DEFAULT NULL,
...
--
-- Struktur-dump for tabellen `workflow_transitions`
--
...
--
-- Indeks for tabel `defect_reports`
--
ALTER TABLE `defect_reports`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_pager_id` (`pager_id`),
  ADD KEY `dr_ibfk_2` (`reported_by_user_id`);

--
-- Indeks for tabel `defect_report_symptoms`
--
ALTER TABLE `defect_report_symptoms`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_report_symptom` (`report_id`,`symptom_id`),
  ADD KEY `drs_ibfk_2` (`symptom_id`);

--
-- Indeks for tabel `defect_symptoms`
--
ALTER TABLE `defect_symptoms`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks for tabel `preparation_checks`
--
ALTER TABLE `preparation_checks`
  ADD PRIMARY KEY (`id`);

--
-- Indeks for tabel `preparation_results`
--
ALTER TABLE `preparation_results`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_pager_id` (`pager_id`),
  ADD KEY `pr_ibfk_2` (`checked_by_user_id`);

--
-- Indeks for tabel `preparation_result_items`
--
ALTER TABLE `preparation_result_items`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_result_check` (`result_id`,`check_id`),
  ADD KEY `pri_ibfk_2` (`check_id`);
...
--
-- Indeks for tabel `workflow_transitions`
--
ALTER TABLE `workflow_transitions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_event_from_to` (`event`,`from_status`,`to_status`);
...
--
-- Tilføj AUTO_INCREMENT i tabel `defect_reports`
--
ALTER TABLE `defect_reports`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tilføj AUTO_INCREMENT i tabel `defect_report_symptoms`
--
ALTER TABLE `defect_report_symptoms`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tilføj AUTO_INCREMENT i tabel `defect_symptoms`
--
ALTER TABLE `defect_symptoms`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tilføj AUTO_INCREMENT i tabel `preparation_checks`
--
ALTER TABLE `preparation_checks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tilføj AUTO_INCREMENT i tabel `preparation_results`
--
ALTER TABLE `preparation_results`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tilføj AUTO_INCREMENT i tabel `preparation_result_items`
--
ALTER TABLE `preparation_result_items`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tilføj AUTO_INCREMENT i tabel `workflow_transitions`
--
ALTER TABLE `workflow_transitions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Begrænsninger for tabel `defect_reports`
--
ALTER TABLE `defect_reports`
  ADD CONSTRAINT `dr_ibfk_1` FOREIGN KEY (`pager_id`) REFERENCES `pagers` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `dr_ibfk_2` FOREIGN KEY (`reported_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Begrænsninger for tabel `defect_report_symptoms`
--
ALTER TABLE `defect_report_symptoms`
  ADD CONSTRAINT `drs_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `defect_reports` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `drs_ibfk_2` FOREIGN KEY (`symptom_id`) REFERENCES `defect_symptoms` (`id`) ON DELETE CASCADE;
...
--
-- Begrænsninger for tabel `preparation_results`
--
ALTER TABLE `preparation_results`
  ADD CONSTRAINT `pr_ibfk_1` FOREIGN KEY (`pager_id`) REFERENCES `pagers` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pr_ibfk_2` FOREIGN KEY (`checked_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Begrænsninger for tabel `preparation_result_items`
--
ALTER TABLE `preparation_result_items`
  ADD CONSTRAINT `pri_ibfk_1` FOREIGN KEY (`result_id`) REFERENCES `preparation_results` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pri_ibfk_2` FOREIGN KEY (`check_id`) REFERENCES `preparation_checks` (`id`) ON DELETE CASCADE;
